...
create table status_poste(
	id_status_poste int primary key auto_increment,
...
create table poste(
    ...
    cep char (9),
    fk_status_poste int,
    foreign key (fk_status_poste) references status_poste (id_status_poste)
);
...
create table admin(
    ...
    fk_nivel_usuario int,
    foreign key (fk_nivel_usuario) references nivel_usuario (id_nivel_usuario)
);
