...
const int sensorLuminosidade = A2; //pega os valores da porta A2 na qual esta o sensor ldr
float volts = 0; // pegara o valor pego do ldr convertido em volts

const int potenciometro = A0; //armazenara o valor obtido pelo potenciometro
...
void loop()
{
  ...
  if(sensorPresenca == 0)
  {
    ...
    Serial.print(":");
    Serial.println(valorPotenciometro); // apresenta o valor obtido pelo potenciometro
  }
  else
  {
